        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to={`/${collectionMapping['náhrdelníky']}`} className="text-luxury-foreground/80 hover:text-gold transition-colors duration-300">Náhrdelníky</Link></li>
              <li><Link to={`/${collectionMapping['náušnice']}`} className="text-luxury-foreground/80 hover:text-gold transition-colors duration-300">Náušnice</Link></li>
              <li><Link to={`/${collectionMapping['prsteny']}`} className="text-luxury-foreground/80 hover:text-gold transition-colors duration-300">Prsteny</Link></li>
              <li><Link to={`/${collectionMapping['náramky']}`} className="text-luxury-foreground/80 hover:text-gold transition-colors duration-300">Náramky</Link></li>
            </ul>
          </div>
