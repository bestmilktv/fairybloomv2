        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <div className="mt-16 pt-12 border-t border-primary/20">
              <h2 className="text-3xl md:text-4xl font-serif font-semibold text-primary mb-8 text-center">
                Naše hodnoty
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-serif font-semibold text-primary mb-4">Ruční výroba</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-serif font-semibold text-primary mb-4">Přírodní materiály</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-serif font-semibold text-primary mb-4">Česká kvalita</h3>
                  <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="mt-16 pt-12 border-t border-primary/20 text-center">
              <p className="text-2xl md:text-3xl font-serif font-semibold text-primary leading-relaxed">
